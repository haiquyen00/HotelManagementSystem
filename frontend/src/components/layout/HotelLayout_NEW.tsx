// filepath: c:\Users\HELLO\Desktop\PRN232\FEGroupPRN232\nextjs-app\src\components\layout\HotelLayout.tsx
'use client';
  ...
  return (
    <div className="flex h-screen bg-pearl-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Page Content */}
        <main className="flex-1 overflow-y-auto p-6 bg-pearl-white">
          {children}
        </main>
      </div>
    </div>
